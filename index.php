...
<body>
    <div class="container-fluid bg-primary">
        <div class="row d-flex justify-content-between align-items-center text-white">
            ...
            <div class="col-4 d-flex">
                ...
                <div class="title-notification ms-3">Notificações</div>
                <div class="icon-num-notification d-flex justify-content-center align-items-center">0</div>
            </div>
            <div class="col-6 d-flex justify-content-end align-items-center">
                <div class="title-user">
                    <span>Nome do Usuário:</span>
                </div>
                <div class="icon-user ms-5">
    ...
    <div class="system-sige">
        <div class="navigation">
            ...
            <a class="inscricoes" href="?page=inscricoes">
                <span class="icon-inscricoes">
                ...
                <p class="inscricoes-hidden">INSCRIÇÕES</p>
            </a>

            <a class="alunos" href="?page=alunos">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-video3" viewBox="0 0 16 16">
                    <path d="M14 9.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm-6 5.7c0 .8.8.8.8.8h6.4s.8 0 .8-.8-.8-3.2-4-3.2-4 2.4-4 3.2Z" />
                    <path d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h5.243c.122-.326.295-.668.526-1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v7.81c.353.23.656.496.91.783.059-.187.09-.386.09-.593V4a2 2 0 0 0-2-2H2Z" />
                </svg>
                <p class="alunos-hidden">ALUNOS</p>
            </a>

            <a class="professores" href="?page=professores">
                ...
                <p class="professores-hidden">PROFESSORES</p>
            </a>

            <a class="funcionarios" href="?page=funcionarios">
                ...
                <p class="funcionarios-hidden">FUNCIONÁRIOS</p>
            </a>

            <a class="usuarios" href="?page=usuarios">
                ...
                <p class="usuarios-hidden">USUÁRIOS</p>
            </a>

            <a class="gerenciar" href="?page=gerenciar">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-bookmarks" viewBox="0 0 16 16">
                    <path d="M2 4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v11.5a.5.5 0 0 1-.777.416L7 13.101l-4.223 2.815A.5.5 0 0 1 2 15.5V4zm2-1a1 1 0 0 0-1 1v10.566l3.723-2.482a.5.5 0 0 1 .554 0L11 14.566V4a1 1 0 0 0-1-1H4z" />
                    <path d="M4.268 1H12a1 1 0 0 1 1 1v11.768l.223.148A.5.5 0 0 0 14 13.5V2a2 2 0 0 0-2-2H6a2 2 0 0 0-1.732 1z" />
                </svg>
                <p class="gerenciar-hidden">GERÊNCIAR</p>
            </a>

            <a class="notas" href="?page=notas">
                ...
                <p class="notas-hidden">NOTAS</p>
            </a>

            <a class="exames" href="?page=exames">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-file-medical" viewBox="0 0 16 16">
                ...
                <p class="exames-hidden">EXAMES</p>
            </a>

            <a class="personalizacoes" href="?page=personalizacoes">
                ...
                <p class="personalizacoes-hidden">PERSONALIZAÇÕES</p>
            </a>
        </div>

        <div class="content-system col-11">
            <?php
            include("config.php");
            switch (@$_REQUEST["page"]) {
                ...
                case "personalizacoes":
                    include("personalizacoes.php");
                    break;

                case "salvar_nova_inscricao":
                    include("salvar_nova_inscricao.php");
                break;

                case "editar_inscricoes":
                    include("editar_inscricoes.php");
                break;
